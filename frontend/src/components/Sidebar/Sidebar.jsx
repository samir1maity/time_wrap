...
import { Search, LayoutDashboard, Calendar, CheckSquare, Paintbrush, Moon, ChevronDown, Settings, HelpCircle, Clock } from 'lucide-react';
...
//   const [activeItem, setActiveItem] = useState('Calendar');
  ...
  return (
    <motion.div
      ...
      className={`h-screen bg-white ${isDarkMode ? 'dark:bg-gray-800 dark:text-white' : ''} p-4 shadow-lg`}
    >
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {!isCollapsed && <h1 className="text-xl font-bold">Time Wrap</h1>}
      </motion.div>
